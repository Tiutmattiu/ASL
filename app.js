...
// ============================================================
// FIXED SCAN PLAN
// Internal TMH windows are planning grids.
// Participants see only the START time as suggested arrival.
// ============================================================

const SCAN_PLAN = {
  "2026-09-13 14:00–14:30": { order: "POLYU_FIRST", tmh: "2026-09-13 16:00–16:30" },
  "2026-09-13 14:30–15:00": { order: "POLYU_FIRST", tmh: "2026-09-13 16:30–17:00" },

  "2026-10-04 09:00–09:30": { order: "POLYU_FIRST", tmh: "2026-10-04 11:00–11:30" },
  "2026-10-04 09:30–10:00": { order: "POLYU_FIRST", tmh: "2026-10-04 11:30–12:00" },
  "2026-10-04 10:00–10:30": { order: "POLYU_FIRST", tmh: "2026-10-04 12:00–12:30" },
  "2026-10-04 10:30–11:00": { order: "POLYU_FIRST", tmh: "2026-10-04 12:30–13:00" },

  "2026-10-04 11:00–11:30": { order: "TMH_FIRST", tmh: "2026-10-04 09:00–09:30" },
  "2026-10-04 11:30–12:00": { order: "TMH_FIRST", tmh: "2026-10-04 09:30–10:00" },
  "2026-10-04 12:00–12:30": { order: "TMH_FIRST", tmh: "2026-10-04 10:00–10:30" },
  "2026-10-04 12:30–13:00": { order: "TMH_FIRST", tmh: "2026-10-04 10:30–11:00" },

  "2026-10-04 13:00–13:30": { order: "POLYU_FIRST", tmh: "2026-10-04 15:00–15:30" },
  "2026-10-04 14:30–15:00": { order: "POLYU_FIRST", tmh: "2026-10-04 16:30–17:00" },

  "2026-10-04 16:00–16:30": { order: "TMH_FIRST", tmh: "2026-10-04 13:00–13:30" },
  "2026-10-04 16:30–17:00": { order: "TMH_FIRST", tmh: "2026-10-04 13:30–14:00" },
  "2026-10-04 17:00–17:30": { order: "TMH_FIRST", tmh: "2026-10-04 14:00–14:30" },
  "2026-10-04 17:30–18:00": { order: "TMH_FIRST", tmh: "2026-10-04 14:30–15:00" },
  "2026-10-04 18:00–18:30": { order: "TMH_FIRST", tmh: "2026-10-04 15:30–16:00" },

  "2026-10-10 09:00–09:30": { order: "POLYU_FIRST", tmh: "2026-10-10 11:00–11:30" },
  "2026-10-10 09:30–10:00": { order: "POLYU_FIRST", tmh: "2026-10-10 11:30–12:00" },

  "2026-10-10 11:30–12:00": { order: "TMH_FIRST", tmh: "2026-10-10 09:00–09:30" },

  "2026-10-10 12:00–12:30": { order: "POLYU_FIRST", tmh: "2026-10-10 14:00–14:30" },

  "2026-10-10 12:30–13:00": { order: "TMH_FIRST", tmh: "2026-10-10 09:30–10:00" },
  "2026-10-10 13:00–13:30": { order: "TMH_FIRST", tmh: "2026-10-10 10:30–11:00" },

  "2026-10-10 14:30–15:00": { order: "POLYU_FIRST", tmh: "2026-10-10 16:30–17:00" },

  "2026-10-10 16:30–17:00": { order: "TMH_FIRST", tmh: "2026-10-10 13:30–14:00" },
  "2026-10-10 17:00–17:30": { order: "TMH_FIRST", tmh: "2026-10-10 14:30–15:00" },
  "2026-10-10 17:30–18:00": { order: "TMH_FIRST", tmh: "2026-10-10 15:00–15:30" },
  "2026-10-10 18:00–18:30": { order: "TMH_FIRST", tmh: "2026-10-10 15:30–16:00" }
};
...
const T = {
  zh: {
    ...
    step: "步驟",
    phoneTitle: "輸入聯絡電話",
    phoneHelp: "請使用研究登記時提供的完整電話號碼。",
    phone: "電話號碼",
    continue: "繼續",
    finding: "正在查找…",
    notFound: "找不到這個電話號碼，請檢查後再試。",
    genericError: "暫時無法連接預約系統，請稍後再試。",
    hello: "你好",
    identity: "請確認這是你的姓名。",
    arranged: "你的檢查時間已經安排。",
    notices: "請逐項閱讀掃描準備事項",
    ...
    collectTmh: "完成屯門醫院掃描後領取 HK$200 津貼。",
    collectPolyu: "完成香港理工大學掃描後領取 HK$200 津貼。",

    chooseSlot: "選擇香港理工大學掃描時間",
    noSlots: "目前所有時段已滿，我們會稍後聯絡你安排候補時間。",
    waitlist: "加入候補",
    waitlisted: "你已加入候補名單。",
    review: "核對預約",
    polyuFixed: "香港理工大學：正式預約時間",
    tmhSuggested: "屯門醫院：建議到達時間",
    around: "約",
    hospitalOnly: "此為建議到達時間，供當日行程安排使用；屯門醫院無需另行預約固定時段。",
    order: "次序",

    incentive: "研究參與津貼",
    incentiveTmh: "HK$200 津貼：完成屯門醫院掃描後領取",
    incentivePolyu: "HK$200 津貼：完成香港理工大學掃描後領取",

    back: "返回",
    confirm: "確認預約",
    confirmChange: "確認更改",
    booking: "正在確認…",
    taken: "抱歉，這個時段剛被另一位參與者選取，請選擇其他時間。",
    confirmed: "預約已確認",
    changed: "預約已更改",
    participant: "參與者",

    print: "列印／儲存確認書",
    qrMissing: "校園入場二維碼將另行提供。",
    qrSave: "下載／儲存入場二維碼",
    contact: "聯絡電話",
    polyu: "香港理工大學",
    tmh: "屯門醫院",
    ...
    early: "PolyU 請勿提前超過 15 分鐘到達。",
    change: "更改預約",
    tooLate: "距離預約時間不足 24 小時。如需更改，請直接聯絡研究團隊。",
    paid: "兩次掃描及 HK$200 津貼發放已完成。"
  },

  en: {
    title: "Study scan booking",
    footer: "Consistency of arterial spin labelling imaging across field strengths",
    step: "Step",
    phoneTitle: "Enter your contact number",
    phoneHelp: "Use the full phone number provided when you joined the study.",
    phone: "Phone number",
    continue: "Continue",
    finding: "Looking up…",
    notFound: "We could not find that phone number. Please check and try again.",
    genericError: "The booking service is temporarily unavailable. Please try again later.",
    hello: "Hello",
    identity: "Please confirm this is your name.",
    arranged: "Your scan arrangement has already been completed.",
    notices: "Read each scan preparation instruction",
    understand: "I understand",
    understood: "Understood ✓",

    chooseOrder: "Which location would you like to visit first?",
    sameDay: "You must complete both the PolyU and Tuen Mun Hospital scans on the same day.",
    scheduleRule: "The PolyU scan has a fixed appointment time. Each time is paired with a planned scan order for the two locations.",
    travelRule: "No separate fixed appointment is required at Tuen Mun Hospital. The system will provide a suggested arrival time. Allow approximately 1–1.5 hours for travel between the two locations.",

    polyuFirst: "PolyU → Tuen Mun Hospital",
    tmhFirst: "Tuen Mun Hospital → PolyU",
    collectTmh: "Receive the HK$200 incentive after completing your Tuen Mun Hospital scan.",
    collectPolyu: "Receive the HK$200 incentive after completing your PolyU scan.",

    chooseSlot: "Choose a PolyU scan time",
    noSlots: "All slots are currently full. We will contact you about a waitlist time.",
    waitlist: "Join waitlist",
    waitlisted: "You have joined the waitlist.",
    review: "Review appointment",
    polyuFixed: "PolyU: fixed appointment",
    tmhSuggested: "Tuen Mun Hospital: suggested arrival",
    around: "Around",
    hospitalOnly: "This is a suggested arrival time for planning your trip. No separate fixed hospital appointment is required.",
    order: "Order",

    incentive: "Study participation incentive",
    incentiveTmh: "HK$200 incentive: collect after completing the Tuen Mun Hospital scan",
    incentivePolyu: "HK$200 incentive: collect after completing the PolyU scan",

    back: "Back",
    confirm: "Confirm booking",
    confirmChange: "Confirm change",
    booking: "Confirming…",
    taken: "Sorry, this time was just selected by another participant. Please choose another available time.",
    confirmed: "Appointment confirmed",
    changed: "Appointment changed",
    participant: "Participant",

    print: "Print / save appointment",
    qrMissing: "Campus entry QR code will be provided separately.",
    qrSave: "Download / save QR code",
    contact: "Contact",
    polyu: "The Hong Kong Polytechnic University",
    tmh: "Tuen Mun Hospital",
    preparation: "Scan preparation",
    travel: "Allow approximately 1–1.5 hours for public transport.",
    early: "Do not arrive at PolyU more than 15 minutes early.",
    change: "Change appointment",
    tooLate: "Your appointment is less than 24 hours away. Please contact the study team directly if you need to make a change.",
    paid: "Both scans and the HK$200 incentive payment have been completed."
  }
};
...
function slotParts(slot) {
  ...
  return i < 0
    ? { date: "", time: text }
    : { date: text.slice(0, i), time: text.slice(i + 1) };
}

const dateLabel = date => SLOT_LABELS[state.lang][date] || date;
const orderLabel = order => order === "POLYU_FIRST" ? tr("polyuFirst") : tr("tmhFirst");
const incentiveText = order => order === "POLYU_FIRST" ? tr("incentiveTmh") : tr("incentivePolyu");

function tmhArrivalDisplay(value) {
  return slotParts(value).time.split("–")[0];
}

function requiredOrderForSlot(slot) {
  return SCAN_PLAN[String(slot || "").trim()]?.order || "";
}

function slotAllowedForOrder(slot, order) {
  return requiredOrderForSlot(slot) === order;
}

function suggestedHospitalTime(slot, order) {
  const plan = SCAN_PLAN[String(slot || "").trim()];
  return plan && plan.order === order ? tmhArrivalDisplay(plan.tmh) : "";
}
...
async function api(payload) {
  if (!ASL_CONFIG.WEB_APP_URL.startsWith("https://script.google.com/")) {
  ...
  if (!result.ok) {
    throw Object.assign(
      new Error(result.message || "API error"),
...
async function lookup(event) {
  ...
  try {
    ...
    state.slots = result.availableSlots;
    state.noticesDone = 0;
    ...
    renderPhone(error.code === "NOT_FOUND" ? tr("notFound") : tr("genericError"));
  }
}
...
function renderParticipant() {
  state.step = "participant";
  setProgress(2);

  const blocked = ["S001", "S002"].includes(state.participant.sid);

  app.innerHTML = `
    <h2>${tr("hello")}, ${esc(state.participant.name)}</h2>
    <p>${blocked ? tr("arranged") : tr("identity")}</p>
    ${blocked ? "" : `<button id="identity-confirm">${tr("continue")}</button>`}
  `;

  document.querySelector("#identity-confirm")
    ?.addEventListener("click", renderNotices);
}
...
function renderNotices() {
    ...
    list.insertAdjacentHTML("beforeend", `
      <div class="notice ${done ? "done" : unlocked ? "" : "locked"}">
        ...
        <button
          type="button"
          data-notice="${index}"
          ${unlocked && !done ? "" : "disabled"}
        >${done ? tr("understood") : tr("understand")}</button>
      </div>
    `);
  });
  ...
  if (state.noticesDone === NOTICES[state.lang].length) {
    list.insertAdjacentHTML(
      "beforeend",
      `<div class="actions"><button id="to-order">${tr("continue")}</button></div>`
    );
  }

  list.onclick = event => {
    if (event.target.hasAttribute("data-notice")) {
      state.noticesDone++;
      renderNotices();
    }
  };
...
function renderSlots(message = "") {
  ...
  const visibleSlots = state.slots.filter(
    slot => slotAllowedForOrder(slot, state.order)
  );
  ...
  if (!state.slots.length) {
    ...
    document.querySelector("#waitlist")?.addEventListener("click", joinWaitlist);
  ...
  Object.entries(groups).forEach(([date, slots]) => {
    container.insertAdjacentHTML("beforeend", `
      <div class="date-group">
        ...
        <div class="slot-grid">
          ${slots.map(slot => `
            <button class="choice" type="button" data-slot="${esc(slot)}">
              ${esc(slotParts(slot).time)}
            </button>
          `).join("")}
        </div>
      </div>
...
async function joinWaitlist(event) {
  ...
  try {
    await api({ action: "waitlist", phone: state.phone });
    renderSlots("done");

  } catch (error) {
    if (error.code === "SLOTS_AVAILABLE") {
      state.slots = error.result.availableSlots || [];
      renderSlots();
      ...
      app.insertAdjacentHTML(
        "afterbegin",
        `<p class="error">${tr("genericError")}</p>`
      );
    }
  }
}
...
function renderReview() {
  ...
  const { date, time } = slotParts(state.slot);
  const tmhTime = suggestedHospitalTime(state.slot, state.order);

  app.innerHTML = `
    <h2>${tr("review")}</h2>

    <div class="appointment fixed">
      <span>${tr("polyuFixed")}</span>
      <strong>${dateLabel(date)}<br>${esc(time)}</strong>
    </div>

    <div class="appointment suggested">
      <span>${tr("tmhSuggested")}</span>
      <strong>${tr("around")} ${esc(tmhTime)}</strong>
      <small>${tr("hospitalOnly")}</small>
    </div>

    <div class="summary">
      <div>
        <strong>${tr("order")}</strong><br>
        ${orderLabel(state.order)}
      </div>
      <div>
        <strong>${tr("incentive")}</strong><br>
        ${incentiveText(state.order)}
      </div>
    </div>

    <div class="actions">
      <button class="secondary" id="back">${tr("back")}</button>
      <button id="confirm">${state.changing ? tr("confirmChange") : tr("confirm")}</button>
    </div>
  `;

  document.querySelector("#back").onclick = () => renderSlots();
  document.querySelector("#confirm").onclick = saveBooking;
}
...
async function saveBooking(event) {
  event.target.disabled = true;
  event.target.textContent = tr("booking");

  try {
    const result = await api({
      action: state.changing ? "reschedule" : "book",
      phone: state.phone,
      slot: state.slot,
      order: state.order,
      acknowledged: true
    ...
    if (error.code === "SLOT_TAKEN") {
      state.slots = error.result.availableSlots || [];
      renderSlots(tr("taken"));

    } else if (error.code === "RESCHEDULE_TOO_LATE") {
      state.participant.appointment.canReschedule = false;
      renderConfirmation();

    } else if (error.code === "ORDER_REQUIRED") {
      state.slot = "";
      renderOrder();
...
function renderConfirmation() {
  ...
  const { date, time } = slotParts(a.polyuTime);
  const tmhTime = tmhArrivalDisplay(a.tmhTime);
  const qr = safeUrl(a.qr);
  ...
  app.innerHTML = `
    <h2 class="success">${state.changed ? tr("changed") : tr("confirmed")}</h2>
    ...
    <address>
      ...
      ${tr("contact")}: ${esc(ASL_CONFIG.POLYU_CONTACT)}
    </address>
    ...
    <address>
      ...
      ${tr("contact")}: ${esc(ASL_CONFIG.TMH_CONTACT)}
    </address>

    <p class="important">
      <strong>${tr("travel")}</strong><br>
      ${tr("early")}
    </p>
    ...
    <div class="actions no-print">
      ...
      ${
        a.canReschedule
          ? `<button class="secondary" id="change">${tr("change")}</button>`
          : ""
      }
    </div>
    ...
    ${
      a.incentivePaid
        ? `<p class="success">${tr("paid")}</p>`
        : !a.canReschedule
          ? `<p class="muted">${tr("tooLate")}</p>`
          : ""
    }
  `;
